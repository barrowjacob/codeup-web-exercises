...
mapboxgl.accessToken = "pk.eyJ1IjoiamFjb2JiYXJyb3ciLCJhIjoiY2syMmo3OWJiMG03NjNobWxpdGd6NzAxbiJ9.qCyaMXk6sE1v2YTCYeFt5w";
...
//
    geocode("12310 Switchgrass, San Antonio, TX 78252", mapboxToken).then(function(result) {
        console.log(result);
        map.flyTo({
            center: result,
            zoom: 14,
